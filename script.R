...
colors
### THE ORDERING WASN'T KEPT WHEN CREATING THE NEW DATA TABLE SO I JUST REDID THE ORDERING 
colors$Color <- ordered(colors$Color, levels=c("Black","Blue","White","Green","Red", "Grey",
                                               ...
                                               "Diamond Blue","Cream/Ivory","Beige", "Not Given"))
colors$Color
### NEXT WE OUTPUT THE PLOT FOR THE COUNT OF THE PAINTJOB ON BIKES 
gg <- ggplot(colors, aes(Color, Counts, fill=factor(Color))) + 
geom_bar(stat='identity', colour = "turquoise2") + theme_minimal() +
labs(title = "Color of Bikes Stolen within Isla Vista (2011-2016)") + theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
scale_fill_manual(values=c("#000000", "#1f23af", "#ffffff", "#03c11d", "#dd1616", "#808080", 
                           "#C0C0C0", "#ffff00", "#800080","#FFC0CB", "#FF8C00", "#8B4513", 
                           "#76EE00", "#ADD8E6", "#800000", "turquoise4", "#006400", "#D2B48C", 
